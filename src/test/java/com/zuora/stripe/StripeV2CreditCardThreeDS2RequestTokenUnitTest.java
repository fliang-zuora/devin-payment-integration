...
public class StripeV2CreditCardThreeDS2RequestTokenUnitTest extends OpgJsonBaseTest {
    ...
    public void case_01_ThreeDs2RequestTokenSuccessful() {
        ...
        assertEquals("paymentIntentId=pi_3PYiXQ4ZWiZesCzm17XwxlH9&paymentIntentStatus=requires_payment_method", responseMap.get("ThreeDS2ResponseData"));
