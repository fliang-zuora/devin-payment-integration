...
public class StripeV2AchRefundUnitTest extends OpgJsonBaseTest {
    private static final ZUtility zUtility = new ZUtility();

    @Test
    public void case_01_ItShouldSucceedForNormalRefund() {
        final String case_01_refund_response = "/com/zuora/billing/opg/test/json/stripe_2/ach/refund/case_01/refund_response.json";
        ...
        final Payment payment = PaymentBuilder.aPayment()
                ...
                .withPaymentReferenceId("ch_1MAcjnHo3zohLKRe4Quaahlk")
                .build();
        ...
        Map<String, String> requestMap = OpgRequestMapHelper.constructRefundCallRequestMap(refund, paymentGateway, false);
        ...
        assertEquals("re_3NlAiHSC2hQ3y1el0Ohtr84C", responseMap.get("GatewayReferenceId"));
        ...
        verifyConnectorRequest(httpsConnector,
                ConnectorHeadersVerifierBuilder.newInstance()
                        ...
                        .matchesRequestPayload(
                                ...
                                Matchers.allOf(
                                        Matchers.hasEntry("charge", "ch_1MAcjnHo3zohLKRe4Quaahlk"),
    ...
    public void case_02_ReturnUnknownZuoraResponseCodeWhenGatewayReturns5XXHttpStatus() {
        final String case_02_refund_response = "/com/zuora/billing/opg/test/json/stripe_2/ach/refund/case_02/refund_response.json";
        final String tokenId = "ba_1MAcjnHo3zohLKRe4Quaahlk"; // default_source in the get_customer_status_response.json
        final OpenPaymentGateway opg = buildOpenPaymentGatewayForTest(false,
                StripeTestHelper.buildPaymentGatewaySettingRepositoryForTest(null));
        final String idempotencyKey = zUtility.getUUID(64);
        ...
        final Payment payment = PaymentBuilder.aPayment()
                ...
                .withPaymentNumber("P-00031467")
                .withPaymentMethod(paymentMethod)
                .withPaymentReferenceId("pi_1MAcjnHo3zohLKRe4Quaahlk")
                .withBillingAccount(billingAccount)
                .build();
        ...
        verifyConnectorRequest(httpsConnector,
                ConnectorHeadersVerifierBuilder.newInstance()
                        ...
                        .matchesRequestPayload(
                                new StripeRequestPayloadExtractor(),
                                Matchers.allOf(
                                        Matchers.hasEntry("payment_intent", "pi_1MAcjnHo3zohLKRe4Quaahlk"),
                                        Matchers.hasEntry("amount", "1000"),
                                        Matchers.hasEntry("metadata[zrefund_number]", "R-0000001")
                                ),
                                "check request payload")
