...
public class StripeV2BankTransferRefundUnitTest extends OpgJsonBaseTest {
    ...
    public void case_03_ItShouldSucceedForRefundWithPaymentIntentId() {
        ...
        final Refund refund = RefundBuilder.aRefund()
                .withRefundNumber("R-0000001")
                .withReferenceID("pi_3ODDWQLhIv5irhST1qxfBVdD")
                .withBillingAccount(billingAccount)
                .withPaymentMethod(paymentMethod)
                .withTotalAmount(Decimal.valueOf("10"))
                .withPayment(payment)
                ...
                ConnectorHeadersVerifierBuilder.newInstance()
                        ...
                        .matchesRequestPayload(
                                ...
                                Matchers.allOf(
                                        Matchers.hasEntry("amount", "1000"),
                                        Matchers.hasEntry("metadata[zrefund_number]", "R-0000001"),
                                        Matchers.hasEntry("payment_intent", "pi_3ODDWQLhIv5irhST1qxfBVdD")
                                ),
                                "check request payload")
                        .build());
    }
    ...
    public void case_04_ItShouldSucceedForRefundWithChargeId() {
        ...
        final Refund refund = RefundBuilder.aRefund()
                .withRefundNumber("R-0000001")
                .withReferenceID("py_3ODDWQLhIv5irhST140KOic1")
                .withBillingAccount(billingAccount)
                .withPaymentMethod(paymentMethod)
                .withTotalAmount(Decimal.valueOf("10"))
                .withPayment(payment)
                ...
                ConnectorHeadersVerifierBuilder.newInstance()
                        ...
                        .matchesRequestPayload(
                                ...
                                Matchers.allOf(
                                        Matchers.hasEntry("amount", "1000"),
                                        Matchers.hasEntry("metadata[zrefund_number]", "R-0000001"),
                                        Matchers.hasEntry("charge", "py_3ODDWQLhIv5irhST140KOic1")
                                ),
                                "check request payload")
                        .build());
    }
